...
# rblake50,08.09.2021,Modified code to complete assignment 6
# ------------------------------------------------------------------------- #
...
class Processor:
    ...
    def read_data_from_file(file_name, list_of_rows):
        ...
        file.close()
        return list_of_rows, 'Success - data read from file'

    @staticmethod
    def add_data_to_list(task, priority, list_of_rows):
        """Adds a Task and Priority to the list of dictionary rows
        :param task: (string) of task to add
        :param priority: (string) of priority to add
        :param list_of_rows: (list) you want to add to
        :return: (list) of dictionary rows
        """
        dicRow = {"Task":task,"Priority":priority}
        list_of_rows.append(dicRow)
        return list_of_rows, 'Success - task and priority added to list'

    @staticmethod
    def remove_data_from_list(task, list_of_rows):
        """Removes a desired task from the list
        ...
        for item in list_of_rows:
            if task == item["Task"]:
                ...
                strMsg = 'Success - task(s) removed from list'
        if boolFound == False:
            strMsg = 'Failure - task not found'
    ...
    def write_data_to_file(file_name, list_of_rows):
        ...
        objFileText.close()
        return list_of_rows, 'Success - data written to file'
...
class IO:
    ...
    def input_new_task_and_priority():
        ...
        priority = input("What priority does the task have? ")
